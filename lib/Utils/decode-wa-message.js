...
function decodeMessageNode(stanza, meId, meLid) {
    ...
    // PATCH: versi stabil fromMe
    const fromMe = (0, WABinary_1.areJidsSameUser)(stanza.attrs.participant || stanza.attrs.from, meId) 
                || (0, WABinary_1.areJidsSameUser)(stanza.attrs.participant || stanza.attrs.from, meLid);
    ...
    return {
        ...
        async decrypt() {
            ...
            if ((0, WABinary_1.isJidNewsLetter)(fullMessage.key.remoteJid)) {
                ...
                const msg = WAProto_1.proto.Message.decode(node?.content);
