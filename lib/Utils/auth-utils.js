...
exports.initMultiAuthCreds = exports.initAuthCreds = exports.addTransactionCapability = exports.makeCacheableSignalKeyStore = void 0;
...
/**
 * Adds DB like transaction capability
 */
        ...
        get: async (type, ids) => {
            if (isInTransaction()) {
                ...
                return ids.reduce((dict, id) => {
                    var _a;
                    const value = (_a = transactionCache[type])?.[id];
...
/**
 * for multi session pairing
 * default sessionId = "default"
 */
const initMultiAuthCreds = (sessionId = 'default') => {
    const baseCreds = (0, exports.initAuthCreds)();
    return {
        ...baseCreds,
        sessionId, // additional for multi session
    };
};
exports.initMultiAuthCreds = initMultiAuthCreds;