...
exports.JidServer = 'c.us' | 'g.us' | 'broadcast' | 's.whatsapp.net' | 'call' | 'lid' | 'newsletter' | 'bot'
const jidEncode = (user, server: JidServer, device, agent) => {
...
/** is the jid a user */
const areJidsSameUser = (jid1: string | undefined, jid2: string | undefined) =>
        jidDecode(jid1)?.user === jidDecode(jid2)?.user

exports.areJidsSameUser = areJidsSameUser;
/** is the jid Meta IA */
const isJidMetaIa = (jid: string | undefined) => jid?.endsWith('@bot');
exports.isJidMetaIa = isJidMetaAi;
/** is the jid a user */
...
const jidNormalizedUser = (jid) => {
    ...
    return (0, exports.jidEncode)(user, server === 'c.us' ? 's.whatsapp.net' : server as JidServer);
};
